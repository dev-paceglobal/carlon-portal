<template>
  <v-row class="user-page">
    <baseDialogBox
      @cancelWarning="deleteWarning.visiblity = $event"
      :data="deleteWarning"
    >
      ...
      <base-card>
        <v-card-title>
          <div class="d-flex justify-space-between flex-wrap">
            <v-btn class="ma-2" @click= "toggleAddServiceDrawer" dark color="danger">
...
export default {
  ...
  methods: {
    ...mapActions(["openServiceDrawer"]),
    toggleAddServiceDrawer(){
      this.openServiceDrawer(true)
    },
    deleteWarn(item) {
      this.deleteWarning.id = item.id;
      this.deleteWarning.name = item.title;
      this.deleteWarning.visiblity = true;
    },
  },
